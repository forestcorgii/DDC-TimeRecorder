...
#Region "Public Property"
    ...
    Public Property FingerAvailable As Boolean
        Get
            Return cbFingerAvailable.Checked
        End Get
        Set(value As Boolean)
            cbFingerAvailable.Checked = value
    ...
    Public Property FaceAvailable As Boolean
        Get
            Return cbFaceAvailable.Checked
        End Get
        Set(value As Boolean)
            cbFaceAvailable.Checked = value
            If value Then
...
#End Region
    ...
    Private Sub dgv_CurrentCellChanged(sender As Object, e As EventArgs) Handles dgv.CurrentCellChanged
        If Not dgv.Rows.Count = 0 And dgv.CurrentRow IsNot Nothing Then
            ...
            With userInfo
                ...
                Schedule = .Schedule
                FingerAvailable = .FingerprintAvailable
    ...
    Private Sub btnRegFace_Click(sender As Object, e As EventArgs) Handles btnRegFace.Click
        If FaceAvailable Then
            If MsgBox("Re-scan? Previous data will be overwritten.", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            Else : Exit Sub
            End If
        End If

        Using frmScan As New sfrmFaceReader(userInfo)
            frmScan.ShowDialog()
            If frmScan.Valid Then
                FaceAvailable = True
                userInfo.FaceImage_1 = frmScan.pixSample1.ImageIpl.ToBytes
                userInfo.FaceImage_2 = frmScan.pixSample2.ImageIpl.ToBytes
                userInfo.FaceImage_3 = frmScan.pixSample3.ImageIpl.ToBytes
            End If
        End Using
    End Sub

...
Public Class UserRecords
    ...
    Public FaceImage_1 As Byte()
    Public FaceImage_2 As Byte()
    Public FaceImage_3 As Byte()
    Public ReadOnly Property FaceImage_1_mat As OpenCvSharp.Mat
        Get
            If FaceImage_1 IsNot Nothing Then
                Return OpenCvSharp.Mat.FromImageData(FaceImage_1, OpenCvSharp.ImreadModes.GrayScale)
            Else : Return Nothing
            End If
        End Get
    End Property
    Public ReadOnly Property FaceImage_2_mat As OpenCvSharp.Mat
        Get
        ...
        End Get
    End Property
    Public ReadOnly Property FaceImage_3_mat As OpenCvSharp.Mat
        Get
...
#Region "Public Properties"
    Public Property Available As Boolean
        Get
            If Not File.Exists(Application.StartupPath & "\" & ID & ext.datEx) And Not FaceImage_1 Is Nothing Then
                Return False
            Else : Return True
            End If
            '      Return _available
    ...
    Public ReadOnly Property FaceAvailable As Boolean
        Get
            Return FaceImage_1 IsNot Nothing
        End Get
    End Property

    Public ReadOnly Property FingerprintAvailable As Boolean
        Get
            Return File.Exists(Application.StartupPath & "\" & ID & ext.datEx)
        End Get
    End Property
